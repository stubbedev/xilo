...
func TestSmokeAllComponents(t *testing.T) {
	...
	cases := []struct {
		...
		{"Settings", views.Settings(false, nil, views.Flash{}), "Settings"},
		{"Settings-totp-passkeys", views.Settings(true, []store.Passkey{{ID: 1, Name: "yubikey", Created: 1}}, views.Flash{Msg: "saved"}), "yubikey"},
