...
func TestSmokeAllComponents(t *testing.T) {
	...
	cases := []struct {
		...
		{"Settings-totp-passkeys", views.Settings(&store.User{Name: "admin", Role: "admin"}, true, []store.Passkey{{ID: 1, Name: "yubikey", Created: 1}}, []store.User{{ID: 1, Name: "admin", Role: "admin"}}, []views.OrgInfo{{Account: store.Account{ID: 1, Slug: "default"}, Members: []store.AccountMember{{UserID: 1, UserName: "admin", Role: "owner"}}}}, views.Flash{Msg: "saved"}), "yubikey"},
