...
var en = map[string]string{
	...
	"status.makereadonly": "Make read-only",
	...
	"cd.retentionhint": "How long a path is kept after it was last used. Empty keeps it forever.",
	"cd.maxsizehint":   "The most this cache keeps on disk. Empty means no cap.",
	"cd.rotate":        "Rotate",
